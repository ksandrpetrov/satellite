...
MAIN_EMPTY = "🪶 Чайка принесла редкую добычу: день без встреч. Это чистый пляж для фокуса."
MAIN_LIGHT = (
...
MAIN_DENSE = "🪶 Чайка напрягла крылья: день плотный. Встреч много, свободных окон мало."
MAIN_STORM = "🪶 Чайка кричит с мачты: календарный шторм. День почти съеден встречами."
